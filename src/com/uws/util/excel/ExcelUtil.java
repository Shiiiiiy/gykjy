...
public class ExcelUtil {
	...
	* @throws Exception 
	*/
	public static List<Map<Integer,Object>> read(String filePath,ValidateRule[] validate) throws ValidateException, Exception {
		 
		return new POIReadExcel().readExcel(filePath,validate);
	}
	...
	* @throws Exception 
	*/
	public static List<Map<Integer,Object>> read(String filePath,int sheetIndex, int startReadLine, int tailLine,ValidateRule[] validate) throws ValidateException, Exception{
		
			return new POIReadExcel().readExcel(filePath, sheetIndex, startReadLine, tailLine,validate);
	}
