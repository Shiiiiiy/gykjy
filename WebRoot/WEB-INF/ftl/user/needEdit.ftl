...
<div class="container clearfix mt10">
    <div class="bread-nav fl mt10">
        您的位置：<a href="${rc.contextPath}/index">首页</a><span>&gt;</span><a href="${rc.contextPath}/user/index">用户中心</a><span>&gt;</span>需求信息
    </div>
</div>
<!---user--->
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active"><a href="#1" aria-controls="1" role="tab" data-toggle="tab">需求信息</a></li>
                        </ul>
                        <!-- Tab panes -->
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7" style="height:55px;">
                                        <div class="input-group mb15">
                                            <span class="input-group-addon">需&nbsp;&nbsp;求&nbsp;&nbsp;方<font color="red">*</font></span>
                                            <input type="text" <#if ToView??>readonly</#if> name="NAME" value="${(ObjectOne.NAME)!''}" class="form-control" placeholder="请输入需求方" >
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7" style="height:55px;">
                                        <div class="input-group mb15">
                                            <span class="input-group-addon">采购内容<font color="red">*</font></span>
                                            <input type="text" <#if ToView??>readonly</#if> name="DETAIL" value="${(ObjectOne.DETAIL)!''}" class="form-control" placeholder="请输入采购内容" >
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7" style="height:55px;">
                                        <div class="input-group mb15">
                                            <span class="input-group-addon">采购时间<font color="red">*</font></span>
                                            <input type="text" <#if ToView??>readonly</#if> name="START_TIME" value="${(ObjectOne.START_TIME)!''}" class="form-control" placeholder="请输入采购时间" >
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
...
<script type="text/javascript">
    ...
    function subRegisterInfo(){
        if($("#register").valid()){
            ...
            $("#register").attr("action","${rc.contextPath}/user/saveNeed.do");
            $("#register").submit();
        }
    }
    function theEsc(){
        window.location="${rc.contextPath}/user/need";
    }
</script>
</body>
</html>
