                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active"><a href="#1" aria-controls="1" role="tab" data-toggle="tab">需求信息列表</a></li>
                        </ul>
                        <!-- Tab panes -->
                            ...
                            <div role="tabpanel" class="tab-pane active" id="1">
                                ...
                                <div class="table-responsive mt15">
                                    <table class="table table-hover table-striped table-bordered my-table">
                                        <thead>
                                        <tr><th width='5%'>序号</th>
                                            <th width='10%'>需求方名称</th>
                                            <th width='8%'>采购内容</th>
                                            <th width='16%'>计划执行采购时间</th>
                                            <th width='8%'>联系人</th>
                                            <th width='8%'>电话</th>
                                            <th width='8%'>手机</th>
                                            <th width='8%'>邮箱</th>
...
<script>
    function ToNew(O){//编辑和新增
        if(""==(O+"") || undefined == O){
            window.location.href="${rc.contextPath}/user/needEdit.do";
        }else{
            window.location.href="${rc.contextPath}/user/needEdit.do?id="+O;
        }
    }
    function ToView(O){//查看
        O=O+"";
        if(""!=O){
            window.location.href="${rc.contextPath}/user/needView.do?id="+O;
        }
    }
    ...
    function ToDelete(){//删除
        ...
        O=O+"";
        if(""!=O){
            window.location.href="${rc.contextPath}/user/delNeed.do?id="+O;
        }
    }
    function GetMore(){//
