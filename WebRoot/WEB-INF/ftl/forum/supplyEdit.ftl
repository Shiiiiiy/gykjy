    ...
    <div class="container mainbg mt20">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="input-group mb15">
                            <span class="input-group-addon"><font color="red">*</font>供应方名称</span>
                            <input type="text" name="NAME" class="form-control" placeholder="请输入名称" >
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="input-group mb15">
                            <span class="input-group-addon"><font color="red">*</font>销售内容</span>
                            <textarea name="DETAIL" class="form-control" placeholder="销售内容"></textarea>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="input-group mb15">
                            <span class="input-group-addon"><font color="red">*</font>计划执行销售时间</span>
                            <input type="text" name="START_TIME" class="form-control" placeholder="计划执行销售时间(格式:2016-01-01)">
                        </div>
                    </div>
        ...
        $("#register").validate({
				...
				messages: {
					...
					DETAIL:{required:"<font color='red'>此项必填!</font>",minlength:"<font color='red'>销售内容长度不得少于2位字符!</font>",maxlength:"<font color='red'>销售内容长度不得超过300位字符!</font>"},
       ...
       function subRegisterInfo(){
          ...
          if($("#register").valid()){ //主动验证
              ...
              $.ajax({
			        type:"post",
			        dataType: "text",
			        url:"${rc.contextPath}/forum/supplysave.do",
				    data:data,
