...
<body class="con_main_bg">
    ...
    <div class="clearfix mt20 nav_new">
        <div class="bread-nav fl">
            您的位置：<a href="${rc.contextPath}/index">首页</a><span>&gt;</span><a href="${rc.contextPath}/forum" >对接服务</a><span>&gt;</span><a>简历信息</a>
    ...
    <div class="white mt20 mb20">
        <div class="row list-content">
            <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                <h3 class="f16"><i class="iconfont mr5 f20">&#xe6c1;</i>简历信息</h3>
                <div class="newslist-con" style="min-height:800px;word-break:break-all;">
                	<ul id="listmore">
					    <#if NewslistM?? >
						    <#list NewslistM as aa>
						       <li title="${(aa.NAME)!''}"><a href="${rc.contextPath}/user/resumeExports.do?id=${(aa.ID)!''}" target="_blank" ><span class="date">${(aa.REC_TIME)!""}</span>个人简历-${((aa.NAME)!"缺省")}</a></li>   
						    </#list>
					    </#if> 
					</ul>
   ...
   <#include "/footerAndHeader/footers.ftl"/>
    <script type="text/javascript">
        ...
        function GetMore(){/*获取更多*/
	        ...
	        $.post("${rc.contextPath}/forum/moreResume.do",{"pageNo":pageNo},function(obj) {
	        	var shumu=0;
	        	if(obj=="nomore"){
		             $("#tmore").html("没有更多");
	                 ...
	                 $.each(obj,function(index,value){
	                	...
	                	$("#listmore").append(
		                	"<li title="+value.NAME+"><a href=${rc.contextPath}/user/resumeExports.do?id="+value.ID+" target='_blank'><span class='date'>"+value.REC_TIME+"</span>个人简历-"+value.NAME+"</a></li>"  
		                );
		                shumu=shumu+1;
		            });
			        if(shumu < 10){
