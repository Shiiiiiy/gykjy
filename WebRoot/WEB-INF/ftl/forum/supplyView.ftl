                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="input-group mb15">
                            <span class="input-group-addon"><font color="red"></font>供&nbsp;应&nbsp;方&nbsp;名&nbsp;称</span>
                            <input type="text" name="NAME" class="form-control" value="${(NeedsOne.NAME)!''}"  disabled  >
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="input-group mb15">
                            <span class="input-group-addon"><font color="red"></font>销&nbsp;&nbsp;售&nbsp;&nbsp;&nbsp;内&nbsp;&nbsp;容</span>
                            <textarea name="DETAIL" class="form-control"  disabled >${(NeedsOne.DETAIL)!''}</textarea>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="input-group mb15">
                            <span class="input-group-addon"><font color="red"></font>计划销售时间</span>
