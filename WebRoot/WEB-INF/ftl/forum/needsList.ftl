    ...
    <div class="white mt20 mb20">
        <div class="row list-content">
            <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                <h3 class="f16"><i class="iconfont mr5 f20">&#xe6c1;</i>需求信息</h3>
   ...
   <#include "/footerAndHeader/footers.ftl"/>
    <script type="text/javascript">
        ...
        function GetMore(){/*获取更多*/
			...
			//alert(pageNo);
	        $.post("${rc.contextPath}/forum/loadneeds.do",{"pageNo":pageNo},function(obj) {
	        	var shumu=0;
	        	if(obj=="nomore"){
		             $("#tmore").html("没有更多");
	                 ...
	                 $.each(obj,function(index,value){
		                $("#listmore").append(
		                	"<li><a href=${rc.contextPath}/forum/needsview/"+value.ID+" title="+ value.NAME +"><span class='date'>"+value.CREATE_TIME+"</span>"+value.NAME+"</a></li>"
		                );
		                shumu=shumu+1;
		             });
		             if(shumu < 10){
