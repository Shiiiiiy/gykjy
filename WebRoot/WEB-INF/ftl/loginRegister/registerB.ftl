...
<body class="con_main_bg">
    ...
    <div class="mt20 mb20" style="padding-bottom:20px;">
        <div class="row reg-list" style="padding-left:15px;padding-right:15px;">
            ...
            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 reg-item">
                <a href="${rc.contextPath}/register/COMPANY" class="f25 tc active"><i class="iconfont mr10">&#xe611;</i>企业注册</a>
            </div>
            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 reg-item">
                <a href="${rc.contextPath}/register/INSTITUTION" class="f25 tc"><i class="iconfont mr10">&#xe722;</i>机构注册</a>
            </div>
        </div>
        <h2 class="f25 fb title-p"><span class="txt">企业注册</span><span class="line border-c"></span></h2>
        <form id="register" name="register" >
        
            <input type="hidden" id="USERTYPE" name="USERTYPE" value="COMPANY" />
        
            <div class="box-reg">
                <h3 class="f20 lh200 mb20">企业资料</h3>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4" style="height:60px;">
                        <div class="input-group">
                            <span class="input-group-addon"><font color="red">*</font>企业名称</span>
                            <input type="text" name="CP_NAME" class="form-control" placeholder="请输入企业名称(必填项)">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4" style="height:60px;">
                        <div class="input-group">
                            <span class="input-group-addon"><font color="red">*</font>企业联系人</span>
                            <input type="text" name="CP_LINKMAN" class="form-control" placeholder="请输入企业联系人(必填项)">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4" style="height:60px;">
                        <div class="input-group">
                            <span class="input-group-addon"><font color="red">*</font>联系人邮箱</span>
                            <input type="text" name="CP_LINKEMAIL" class="form-control" placeholder="请输入联系人邮箱(必填项)">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4" style="height:60px;">
                        <div class="input-group">
                            <span class="input-group-addon">&nbsp;手机号码&nbsp;</span>
                            <input type="text" name="CP_LINKTEL"  class="form-control" placeholder="请输入手机号码">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4" style="height:60px;">
                        <div class="input-group">
                            <span class="input-group-addon">&nbsp;座&nbsp;机&nbsp;号&nbsp;码&nbsp;</span>
                            <input type="text" name="CP_PHONE" class="form-control" placeholder="请输入座机号码">
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" style="height:60px;">
                        <div class="input-group">
                            ...
                            <input type="text" name="CP_ORGCODE" class="form-control" placeholder="请输入组织机构代码">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" style="height:60px;">
                        <div class="input-group">
                            <span class="input-group-addon">社会信用代码</span>
                            <input type="text" name="CP_SOCIALCODE" class="form-control" placeholder="请输入社会信用代码">
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" style="height:60px;">
                        <div class="input-group">
                            <span class="input-group-addon">住&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;所</span>
                            <input type="text" name="CP_LOCATION" class="form-control" placeholder="请输入住所">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
		...
		jQuery.validator.addMethod("isTel", function(value, element) {       
         ...
         $("#register").validate({
				...
				messages: {
					USERNAME:{required:"<font color='red'>此项必填!</font>",minlength:"<font color='red'>用户名长度不得少于6位字符!</font>",maxlength:"<font color='red'>用户名长度不得超过20位字符!</font>"},
					...
					CP_NAME:{required:"<font color='red'>此项必填!</font>",minlength:"<font color='red'>企业名称长度不得少于2位字符!</font>",maxlength:"<font color='red'>企业名称长度不得超过20位字符!</font>"},
				    CP_LINKMAN:{required:"<font color='red'>此项必填!</font>",minlength:"<font color='red'>联系人名字长度不得少于2位字符!</font>",maxlength:"<font color='red'>联系人名字不得超过20位字符!</font>"},
				    CP_LINKEMAIL:{email:"<font color='red'>请填入正确格式的邮箱号!</font>",required:"<font color='red'>此项必填!</font>"},
				    CP_LINKTEL:{required:"<font color='red'>此项必填!</font>"},
